...
var _Player = _interopRequireDefault(__webpack_require__(31));

var _Playlist = _interopRequireDefault(__webpack_require__(36));

var _VideoInfo = _interopRequireDefault(__webpack_require__(40));

var _spinner = _interopRequireDefault(__webpack_require__(42));

var _App = _interopRequireDefault(__webpack_require__(43));

var _getPlaylist = _interopRequireDefault(__webpack_require__(44));
...
function (_Component) {
  function App() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(App)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.state = {
      ...
      (0, _getPlaylist.default)('documentary').then(function (results) {
        _this.setState({
          isLoading: false,
    ...
    }, _this.loadVideo = function (video) {
      _this.setState({
        currentVideo: video
      });
    }, _temp));
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: _App.default.content
      }, state.isLoading ? _react.default.createElement(_spinner.default, {
        className: _App.default.spinner
      }) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Player.default, {
        video: state.currentVideo
      }), _react.default.createElement(_Playlist.default, {
        videos: state.videos,
        currentVideo: state.currentVideo,
        loadVideo: this.loadVideo
      }), state.currentVideo && _react.default.createElement(_VideoInfo.default, {
        video: state.currentVideo
      }))));
    }
  }]);
...
module.exports = {"header":"Header_header--2Rehd","title":"Header_title--3NLgn"};
...
var _player = _interopRequireDefault(__webpack_require__(32));

var _Player = _interopRequireDefault(__webpack_require__(35));
...
function (_Component) {
  function Player() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Player)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.componentDidMount = function (prevProps) {
      _this.player = new _player.default('player-video', {
      ...
      player.loadVideo(props.video.id).then(function () {
        return player.play();
      });
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(14), __webpack_require__(33).setImmediate))
...
// removed by extract-text-webpack-plugin
module.exports = {"video":"Player_video--2d10u"};
...
var _ListItem = _interopRequireDefault(__webpack_require__(37));

var _Playlist = _interopRequireDefault(__webpack_require__(39));
  ...
  _createClass(Playlist, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: _Playlist.default.listItems,
        ref: function ref(el) {
          return _this2.listItems = el;
        }
        ...
        return _react.default.createElement(_ListItem.default, {
          ...
          itemRef: function itemRef(instance) {
            _this2.refsCollection[video.id] = instance;
          }
        });
      })));
    }
...
var _ListItem = _interopRequireDefault(__webpack_require__(38));
...
var ListItem = function ListItem(props) {
  ...
  }, props.video.name), _react.default.createElement("span", null, props.video.user.name)));
};
...
// removed by extract-text-webpack-plugin
module.exports = {"playlist":"Playlist_playlist--36lIN","title":"Playlist_title--HYdQQ","listItems":"Playlist_listItems--36_3y"};
...
var _VideoInfo = _interopRequireDefault(__webpack_require__(41));
...
var VideoInfo = function VideoInfo(props) {
  return _react.default.createElement("div", {
    className: _VideoInfo.default.videoInfo
  }, _react.default.createElement("h1", {
    className: _VideoInfo.default.title
  }, props.video.name), _react.default.createElement("p", {
    className: _VideoInfo.default.description
...
// removed by extract-text-webpack-plugin
module.exports = {"videoInfo":"VideoInfo_videoInfo--16pAn","title":"VideoInfo_title--2uB6B","description":"VideoInfo_description--3x2jX"};
...
/* harmony default export */ __webpack_exports__["default"] = ((_ref) => {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "svg",
    _extends({ width: "200", height: "200", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid", className: styles["lds-rolling"] || "lds-rolling", style: {
        background: "0 0"
      } }, props),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "circle",
      { cx: "50", cy: "50", fill: "none", stroke: "#00adef", strokeWidth: "10", r: "35", strokeDasharray: "164.93361431346415 56.97787143782138", transform: "rotate(162 50 50)" },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("animateTransform", { attributeName: "transform", type: "rotate", calcMode: "linear", values: "0 50 50;360 50 50", keyTimes: "0;1", dur: "1s", begin: "0s", repeatCount: "indefinite" })
    )
  );
});
...
// removed by extract-text-webpack-plugin
module.exports = {"app":"App_app--1jxEY","content":"App_content--2h-tg","spinner":"App_spinner--3ianR"};
...
var _default = function _default(channelName) {
  return fetch("https://api.vimeo.com/channels/".concat(channelName, "/videos?access_token=b01e6d1ea960f10c41ed22b14baa8c07")).then(function (resp) {
    return resp.json();
  }).then(function (_ref) {
    var data = _ref.data;
    data.forEach(function (item) {
      return item.id = getId(item.uri);
    });
    return data;
  }).catch(function (error) {
